// code/test_vectors/wycheproof_aes_gcm_256_vectors.mjs
//
// Test vectors from C2SP/wycheproof project.
// Apache License 2.0. https://github.com/C2SP/wycheproof
// Vectors extracted from testvectors_v1/aes_gcm_test.json
// Commit: 744697a257d41941320b4ea10987b85b25f8c8bc (Stand 27.04.2026)
//
// Bezug: AP 5.2 Test 5.2-A-11 (Plan v3 §3, Plan v3 §4).
// Filter: keySize=256, ivSize=96, tagSize=128 (Vivodepots Konstellation).
// Aus 316 Wycheproof-Vektoren auf 66 reduziert.
// Result-Codes: "valid" (must succeed), "invalid" (must fail),
// "acceptable" (either is OK — keine Pass-Fail-Bewertung, ADR-055 D3).
//
// Algorithmus: AES-256-GCM mit 12-Byte-IV (96 Bit) und 16-Byte-Tag (128 Bit).
// Inputs: key (256 Bit), iv (96 Bit), aad (variabel, oft leer), msg (variabel).
// Outputs: ct (verschlüsselter msg) + tag (16 Byte Authentication-Tag).
// Web Crypto API liefert ct||tag konkateniert; Tests müssen das splitten.
//
// Datei-Format: Hex-Strings. Konversion zu Uint8Array über bytesFromHex
// vor Einspeisung in crypto.subtle.encrypt/decrypt.

export const wycheproofAesGcm256Vectors = [
  {
    "tcId": 91,
    "comment": "",
    "flags": [
