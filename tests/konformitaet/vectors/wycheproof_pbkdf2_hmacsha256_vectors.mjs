// tests/konformitaet/vectors/wycheproof_pbkdf2_hmacsha256_vectors.mjs
//
// Test vectors from C2SP/wycheproof project.
// Apache License 2.0. https://github.com/C2SP/wycheproof
// Vectors extracted from testvectors_v1/pbkdf2_hmacsha256_test.json
...
//
// Bezug: eine Luecke, die schon VOR dem Zerfall bestand und am 19.08.2026 gemeldet
// wurde (A339). Das Repo prueft HKDF und AES-GCM gegen Wycheproof, PBKDF2 nicht —
// obwohl jedes Oeffnen eines Depots und jeder Vertrauens-Zugang darueber laufen.
// Verwendung: Vivodepots PBKDF2-Ableitung (600 000 Runden, deriveMasterBits
// und deriveKey) gegen externe Vektoren validieren.
// Result-Codes: "valid" (must succeed), "invalid" (must fail),
// "acceptable" (either is OK — keine Pass-Fail-Bewertung, ADR-055 D3).
//
// Algorithmus: PBKDF2 mit HMAC-SHA-256. Schema: pbkdf_test_schema.json.
// Inputs: password, salt (Hex), iterationCount, dkLen (Byte).
// Output: dk (Hex).
//
// UEBERNAHME: byte-unveraendert je Testvektor. Die GRUPPEN-Felder der Quelldatei
// (keine ausser type/source) sind in jeden Vektor hineingezogen, weil diese Datei eine
...
export const wycheproofPbkdf2HmacSha256Vectors = [
  {
    "tcId": 1,
    "comment": "RFC 7914",
    "flags": [
